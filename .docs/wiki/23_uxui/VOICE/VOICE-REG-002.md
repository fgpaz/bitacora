# VOICE-REG-002 — Voz de Registro de factores diarios vía web

## Propósito

Este documento define la voz específica del slice `REG-002`.
...
una pregunta por bloque, cero moralización y lenguaje cotidiano.

## Objetivos verbales

- mantener preguntas simples
- evitar tono evaluativo
- confirmar sin ceremonias
...
- ¿Cumpliste con tu autocuidado?
- Completá todos los campos para un mejor seguimiento
