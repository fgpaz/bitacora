# VOICE-TG-001 — Voz de Vinculación de cuenta Telegram

## Propósito

Este documento define la voz específica del slice `TG-001`.
...
una instrucción por vez y cero jerga técnica.

## Objetivos verbales

- mantener secuencia corta
- decir exactamente qué hacer ahora
- mostrar vencimiento sin alarmismo
