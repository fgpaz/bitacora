# HANDOFF-ASSETS-VIS-001 — Inventario de assets

## Propósito

Este documento explicita qué recursos visuales necesita `VIS-001`.

## Assets especiales

`VIS-001` no requiere assets binarios especiales obligatorios para abrir implementación.
...
- copy exacto de `../VOICE/VOICE-VIS-001.md`.

## Recursos de contenido que sí deben prepararse

| Recurso | Fuente | Uso |
| --- | --- | --- |
| copy de período base | `VOICE-VIS-001.md` | `S01-READY` — sin framing clínico |
| copy de ajuste de período | `VOICE-VIS-001.md` | `S02-PERIOD` — no compite con el chart |
| copy de vacío útil | `VOICE-VIS-001.md` | `S03-EMPTY` — orientación sin confundir con error |
| copy de error | `VOICE-VIS-001.md` | `S03-ERROR` — breve y recuperable |
...
**Siguiente artefacto:** `HANDOFF-MAPPING-VIS-001.md`.
